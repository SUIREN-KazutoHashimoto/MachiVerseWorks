...
{
    public static ProtocolVersion Current => new(2, 23);
    ...
    public bool SupportsRegionalGenerationChunking => Major == 2 && Minor >= 22;
    public bool SupportsScalableMultimodalTransit => Major == 2 && Minor >= 23;
