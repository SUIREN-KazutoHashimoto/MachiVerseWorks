...
public static partial class WorldSaveSerializer
{
    ...
    private static NestedArrayRule GetNestedArrayRule(NestedSaveContext context, NestedSaveProperty property, WorldSaveLimits limits) =>
        (context, property) switch
        {
            ...
            (NestedSaveContext.RegionalGenerationSnapshot, NestedSaveProperty.RegionalSettlements) => new(RegionalGenerationLimits.MaximumSettlements, "simulation.economy.regionalGeneration.snapshot.settlements", NestedArrayKind.None),
            (NestedSaveContext.RegionalGenerationSnapshot, NestedSaveProperty.RegionalGrowthEvents) => new(RegionalGenerationLimits.MaximumGrowthEvents, "simulation.economy.regionalGeneration.snapshot.growthEvents", NestedArrayKind.None),
            (NestedSaveContext.RegionalGenerationSnapshot, NestedSaveProperty.RegionalCorridors) => new(RegionalGenerationLimits.MaximumCorridors, "simulation.economy.regionalGeneration.snapshot.corridors", NestedArrayKind.None),
            (NestedSaveContext.RegionalGenerationSnapshot, NestedSaveProperty.RegionalDistricts) => new(RegionalGenerationLimits.MaximumDistricts, "simulation.economy.regionalGeneration.snapshot.districts", NestedArrayKind.None),
            (NestedSaveContext.RegionalGenerationSnapshot, NestedSaveProperty.RegionalParcels) => new(RegionalGenerationLimits.MaximumParcels, "simulation.economy.regionalGeneration.snapshot.parcels", NestedArrayKind.None),
            (NestedSaveContext.RegionalGenerationSnapshot, NestedSaveProperty.RegionalBuildings) => new(RegionalGenerationLimits.MaximumBuildings, "simulation.economy.regionalGeneration.snapshot.buildings", NestedArrayKind.None),
            (NestedSaveContext.RegionalGenerationSnapshot, NestedSaveProperty.RegionalPois) => new(RegionalGenerationLimits.MaximumPois, "simulation.economy.regionalGeneration.snapshot.pois", NestedArrayKind.None),
            (NestedSaveContext.RegionalGenerationSnapshot, NestedSaveProperty.RegionalToponyms) => new(RegionalGenerationLimits.MaximumToponyms, "simulation.economy.regionalGeneration.snapshot.toponyms", NestedArrayKind.None),
            (NestedSaveContext.RegionalGenerationSnapshot, NestedSaveProperty.RegionalRoadSigns) => new(RegionalGenerationLimits.MaximumRoadSigns, "simulation.economy.regionalGeneration.snapshot.roadSigns", NestedArrayKind.None),
            (NestedSaveContext.RegionalCorridor, NestedSaveProperty.RegionalCorridorGeometry) => new(RegionalGenerationLimits.MaximumCorridorGeometryPoints, "simulation.economy.regionalGeneration.snapshot.corridors[].geometry", NestedArrayKind.None),
