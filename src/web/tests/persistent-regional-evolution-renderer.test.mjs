...
test('SettlementStructureRenderer applies authoritative Phase31 scale, development and lifecycle state', () => {
...
function createGenerationSnapshot() {
  return {
    ...
    districts: [{ districtId: 201n, settlementId: 101n, kind: 1, minX: 0, minY: 0, minZ: 0, maxX: 200, maxY: 200, maxZ: 2, nameId: 0n, accessibility: 1 }],
    parcels: [{ parcelId: 301n, settlementId: 101n, districtId: 201n, minX: 20, minY: 20, minZ: 0, maxX: 80, maxY: 80, maxZ: 1, zone: 1, developmentState: 2, developmentSuitability: 1, landValue: 1, buildingId: 401n }],
