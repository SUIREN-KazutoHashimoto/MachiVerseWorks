...
> **現在:** Phase 1 — 開発プロジェクト骨格  
> **先頭タスク:** `SKL-001` — ルートに `MachiVerseWorks.slnx` を作成する
...
- [x] **完了** — 必要な実装・build・test・benchmark・実機確認まで済んでいる
...
- 「ほぼ完了」「一部完了」は完了扱いにしない。残作業を別 Task ID へ明示的に切り出した場合のみ元タスクを完了にできる。
...
- [x] **SET-002** — ルート `README.md` / `AGENTS.md` を整備する
...
> **状態: 現在**  
> まず C# Solution と Web Client の最小骨格を作り、既存CIを実際のbuildへ接続する。
