...
ARTIFACT_DIR="$ROOT_DIR/.artifacts/phase14-e2e"
WEB_PORT=5175
SERVER_PORT=5082
WEB_PID=""
SERVER_PID=""
...
echo "Phase 14 Signal Traffic Server -> Browser E2E passed."
