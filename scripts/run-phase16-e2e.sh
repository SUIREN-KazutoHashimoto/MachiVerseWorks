...
ARTIFACT_DIR="$ROOT_DIR/.artifacts/phase16-e2e"
WEB_PORT=5174
SERVER_PORT=5081
WEB_PID=""
SERVER_PID=""
...
if "pedestrians" not in health:
    raise SystemExit("Health response does not expose pedestrian count")
print(json.dumps(health, ensure_ascii=False, indent=2))
PY

echo "Phase 16 Building -> Building pedestrian Server -> Browser E2E passed."
